...
// Define a lightweight type for cuisine tags locally. The Prisma client doesn't export
// a `CuisineTag` type directly, so we mirror the fields used here.
interface CuisineTagType {
  id: string;
  name: string;
}
...
export interface RestaurantCardProps {
  ...
  /**
   * A list of cuisine tag objects associated with the restaurant.
   * Each tag should have an `id` and `name`.
   */
  cuisineTags?: CuisineTagType[];
}
